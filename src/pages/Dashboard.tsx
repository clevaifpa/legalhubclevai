...
const Dashboard = () => {
  ...
  const stats = [
    ...
    { title: "Đã ký", value: signed, link: "/tong-hop-dong" },
  ];
      ...
      {categoryStats.length > 0 && (
        <Card className="border-none shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
            ...
            <Link to="/tong-hop-dong"><Button variant="ghost" size="sm" className="text-accent hover:text-accent/80">Quản lý →</Button></Link>
          </CardHeader>
          <CardContent>
