                  ...
                  issues: {
                    ...
                    items: {
                      ...
                      properties: {
                        clause: { type: "string" },
                        riskLevel: { type: "string", enum: ["thap", "trung_binh", "cao"] },
                        reason: { type: "string", description: "Lý do rủi ro, BẮT BUỘC kèm trích dẫn pháp lý cụ thể (tên luật + số hiệu + Điều/Khoản/Điểm)" },
                        suggestion: { type: "string", description: "Hướng xử lý ngắn gọn" },
                        revisedClause: { type: "string", description: "Nội dung điều khoản đề xuất thay thế hoàn chỉnh, có thể dùng ngay" },
                      },
                      required: ["clause", "riskLevel", "reason", "suggestion", "revisedClause"],
